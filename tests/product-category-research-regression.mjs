...
const cases=[
 ...
 {label:'uncommon-electronics',exactUrl:'https://www.takealot.com/proaar-usb-microphone/PLID123456',identification:{brand:'PROAAR',model:'USB microphone',name:'PROAAR USB microphone',object:'microphone',retailCategory:'electronics',searchQuery:'PROAAR USB microphone'},page:'Title: PROAAR USB Microphone\nThe PROAAR USB microphone is a plug-and-play USB microphone for voice recording, calls and streaming on compatible computers. It includes a desktop stand and adjustable positioning.',ai:{researched:true,whatItDoes:'A plug-and-play USB microphone for voice recording, calls and streaming on compatible computers.',pros:['USB connection supports straightforward plug-and-play setup.','Adjustable desktop positioning can help with microphone placement.'],cons:[],bestFor:'Basic voice recording, calls and streaming.',standOut:'Simple USB connectivity with a desktop setup.',valueVerdict:''},must:/usb|microphone|recording|streaming/i},
