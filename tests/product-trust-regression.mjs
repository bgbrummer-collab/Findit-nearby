...
const wrong={retailer:{name:'Ubuy'},product_name:"Nike Women's Modern Classic Basketball Shoe",product_url:'https://www.ubuy.co.za/product/WRONG/nike-womens-modern-classic-basketball-shoe',price:27240,currency:'ZAR',availability:'in_stock',verified:true,sourcePageVerified:true,exactProductMatch:false,matchScore:.99};
const exactLow={retailer:{name:'Ubuy'},product_name:"Nike Men's Air Force 1 '07 Low White",product_url:'https://www.ubuy.co.za/product/RIGHT/nike-air-force-1-07-low-white',price:4684,currency:'ZAR',availability:'in_stock',verified:true,sourcePageVerified:true,exactProductMatch:true,matchScore:.96};
const exactStrong={retailer:{name:'Ubuy'},product_name:"Nike Air Force 1 '07 Low White",product_url:'https://www.ubuy.co.za/product/BEST/nike-air-force-1-07-low-white',price:4599,currency:'ZAR',availability:'in_stock',verified:true,sourcePageVerified:true,exactProductMatch:true,matchScore:.99};
const blackWhite={retailer:{name:'Ubuy'},product_name:"Nike Air Force 1 Low '07 Black White Pebbled Leather",product_url:'https://www.ubuy.co.za/product/BLACKWHITE/nike-air-force-1-07-black-white',price:3509,currency:'ZAR',availability:'in_stock',verified:true,sourcePageVerified:true,exactProductMatch:false,matchScore:.99};
const brown={retailer:{name:'Ubuy'},product_name:"Nike Air Force 1 Low '07 Brown",product_url:'https://www.ubuy.co.za/product/BROWN/nike-air-force-1-low-07-brown',price:4459,currency:'ZAR',availability:'in_stock',verified:true,sourcePageVerified:true,exactProductMatch:false,matchScore:.99};
