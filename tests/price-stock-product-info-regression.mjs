...
if(/R\s?0[,.]00/i.test(txt))throw Error(`Unknown price rendered as zero: ${txt.slice(0,900)}`);
...
if(!/200/.test(best)||/0[,.]00$/.test(best))throw Error(`Best verified price wrong: ${best}`);
