...
(()=>{
  ...
  const loadCompare=()=>loadScript('compare','compare-stock-reliability-fix.js?v=20260910-pricestock6',()=>window.__finditCompareStockReliabilityV2).then(()=>{if(window.__finditCompareStockReliabilityV2)window.__finditCompareStockReliability=true});
  ...
  const loadCommerce=()=>loadScript('commerce','dashboard-commerce-status.js?v=20260910-live5',()=>window.__finditDashboardCommerceStatus);
