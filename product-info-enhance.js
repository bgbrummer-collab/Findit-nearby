...
(()=>{
  ...
  function loadCommerceStatus(){
    ...
    const s=document.createElement('script');s.src='dashboard-commerce-status.js?v=20260910-live1';s.async=false;s.dataset.finditCommerceStatus='1';document.head.appendChild(s);
  }
