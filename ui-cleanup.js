/* FindIt critical UI cleanup. Legacy helper runtimes are intentionally not auto-loaded here.
   Core search, dashboard and result handling are provided by the current runtime files. */
(()=>{
  'use strict';
