...
(()=>{if(window.__finditScannerFlowLoader)return;window.__finditScannerFlowLoader=true;const s=document.createElement('script');s.src='scanner-flow.js?v=20260826-scan1';s.defer=true;document.head.appendChild(s)})();
