...
const DISPLAY_JUNK = /accessible version|data-testid|picturehighquality|!\s*image\s*\d+|encrypted-tbn\d*\.gstatic\.com|faviconv2|\bsrc\s*=|\bhref\s*=|\balt\s*=|\bclass\s*=|\bstyle\s*=|javascript:|webpack|aria-|\bhttps?:\/\/|\\[nrt]|<[^>]+>/i;
